    ...
    <div className={classes.main}>
      ...
      <div className={classes.root}>
        <div className={classes.hero}>
         ...
         {/*    <img src="/rmw.svg" alt="Material-UI Logo" className={classes.logo} />  Big Icon*/}
            ...
            <div className={classes.cardsContent}>
              <Card className={classes.card}>
                ...
                <CardActions>
                  <Button
                    size="small"
                    onClick={() => {
                      var win = window.open('https://www.linkedin.com/in/joaopedromassari/', '_blank')
                      win.focus()
                    }}
                  >
                    Linkedin
              ...
              <Card className={classes.card}>
                <CardContent>
                  ...
                  <br />
                  <Typography>{'Web pack e tecnologias que utilizamos neste projeto'}</Typography>
                  <br />
                  <Typography className={classes.pos} color="textSecondary">
                    {'bla bla bla'}
                    <br />
              ...
              <Card className={classes.card}>
                <CardContent>
                  ...
                  <Typography noWrap={false} color="textSecondary">
                    {` O objetivo do projeto é agilizar a realização dos relatorios automatizando as buscas nas bases de dados governamentais. `}
                    <br />
                    {` Documentação com a arquitetura do projeto, incluindo cloud services, arquitetura da aplicação
                    e como utilizar a aplicação.`}
                  </Typography>
                </CardContent>
                <CardActions>
                  <Button
